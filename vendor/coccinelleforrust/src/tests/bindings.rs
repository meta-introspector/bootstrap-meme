...
fn _testfile(cocci: &str, rs: &str, gbindings: Vec<Vec<(&str, &str)>>) {
    let patchstring =
    ...
    let (mut rules, _, _) = process_cocci(&patchstring);
...
#[test]
pub fn test1() {
    _testfile("bindings/test1.cocci", "bindings/test1.rs", vec![vec![("e", "force")]]);
}
...
#[test]
pub fn test6() {
    _testfile("bindings/test6.cocci", "bindings/test6.rs", vec![vec![("e2", "rigthhand")]]);
}

#[test]
pub fn test7() {
    _testfile("bindings/test7.cocci", "bindings/test7.rs", vec![vec![("e2", "rigthhand")]]);
}
...
#[test]
pub fn test11() {
    _testfile("bindings/test11.cocci", "bindings/test11.rs", vec![vec![("x", "2"), ("y", "1")]]);
}
