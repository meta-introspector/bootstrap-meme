...
*   The **Purpose** of the **SOP: Iterative Program Reconstruction via Semantic Patches** *is to define* a process for evolving Rust programs using **`coccinelleforrust` semantic patches**, ensuring **Auditable, testable, modular code transformations** and facilitating **Self-replication** and **Continuous program evolution**. (Conceptual "purpose and method")
